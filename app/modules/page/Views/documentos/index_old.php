		...
		<div class="col-12 bd-navbar">
			<nav class="navbar navbar-light justify-content-between">
				<a class="navbar-brand">
					<h1 class="titulo2"><i class="fas fa-cogs"></i> <?php echo $this->titlesection; ?></h1>
				</a>
							...
							<div class="row">
								...
								<div class="col-3 form-group">
									...
									<label class="input-group">
										...
										<button data-bs-toggle="modal" data-bs-target="#exampleModal" type="button" class="btn btn-success btn-xs"><img src="/corte/buscador-.png" width="15"></button>
									</label>
								</div>
								<div class="col-3">
									...
									<label class="input-group">
										<div class="input-group-prepend">
											<span class="input-group-text input-icono fondo-verde "><i class="fa-solid fa-calendar"></i></span>
										</div>
								...
								<div class="col-3">
									...
									<label class="input-group">
										<div class="input-group-prepend">
											<span class="input-group-text input-icono fondo-azul-claro "><i class="fa-solid fa-calendar"></i></span>
										</div>
								...
								<div class="col-6 d-grid">
									<label>&nbsp;</label>
									<button type="submit" class="btn btn-primary enviar"> <i class="fas fa-filter"></i> Filtrar</button>
								</div>
							</div>
						</div>
					</form>
