				...
				<div class="container-fluid">
                        ...
                        <div class="content-dashboard">
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <input type="text" class="form-control" name="archivos_asociados" value="<?php echo $this->getObjectVariable($this->filters, 'archivos_asociados') ?>"></input>
                                    </label>
                                </div>
                                <div class="col-3">
                                    <label>&nbsp;</label>
                                    <button type="submit" class="btn btn-block btn-azul w-100 d-block"> <i class="fas fa-filter"></i> Filtrar</button>
                                </div>
                                <div class="col-3">
                                    <label>&nbsp;</label>
                    ...
                    <div class="content-dashboard">
                        ...
                        <table class=" table table-striped  table-hover table-administrator text-left">
                            <thead>
                                <tr>
                                    <td>Archivos Asociados</td>
                                    <td width="100"></td>
                                </tr>
                            </thead>
                            <tbody>
                                <?php foreach($this->lists as $content){ ?>
                                <?php $id =  $content->archivos_id; ?>
                                    <tr>
                                        <td><?=$content->archivos_asociados;?></td>
                                        <td class="text-right">
                                            <div>
                                                ...
                                                <?php if ($_SESSION['kt_login_level'] == 1) { ?>
                                                    <!-- <span data-toggle="tooltip" data-placement="top" title="Eliminar"><a class="btn btn-rojo-claro btn-sm" data-toggle="modal" data-target="#modal<?= $id ?>"  ><i class="fas fa-trash-alt" ></i></a></span> -->
                                                    <?php } ?>
                                            </div>
                                            <!-- Modal -->
